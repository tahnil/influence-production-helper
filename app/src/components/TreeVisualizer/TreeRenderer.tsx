...
import { ProductNode, ExtendedD3HierarchyNode, ProcessNode } from '@/types/d3Types';
...
import ErrorBoundary from '@/components/ErrorBoundary'; // Ensure this import
...
const TreeRenderer: React.FC = () => {
    ...
    const update = useCallback((source: ExtendedD3HierarchyNode | null): void => {
        if (source) {
            unifiedD3Tree(containerRef, rootRef, source.data as ProductNode, updateRef);
        }
    }, []);
